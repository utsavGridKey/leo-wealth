...
const SeventhSection = () => {
  return (
    <section className="w-full overflow-hidden bg-white sm:px-16 md:px-17.5 lg:px-42 xl:px-78">
      <motion.div className="container mx-auto flex flex-col items-center justify-center gap-12 px-6 py-12 md:flex-row md:justify-between md:px-12 md:py-24 lg:gap-24 lg:px-24">
        {/* Text Column */}
        <div className="flex max-w-lg shrink-0 flex-col items-start gap-8 md:max-w-xl">
          <div className="flex flex-col gap-4">
            ...
            <motion.p
              ...
              className="max-w-md font-['Inter',sans-serif] text-sm leading-[1.6] font-medium text-[#707070] md:text-base"
            >
